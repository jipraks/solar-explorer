...
const UI = {
  id: {
    ...
    pilot: "Mode pilot",
    fsOn: "Layar penuh", fsOff: "Keluar layar penuh", install: "Pasang aplikasi",
    ...
    sayBoom: "Kapal hancur!",
    sayRespawn: "Kapal cadangan siap. Kurangi dorongan sebelum mendekat, Kapten.",
    ...
    h7t: "Jadi pilot pesawat", h7d: "Tekan tombol roket di pojok kanan atas untuk mengambil alih kemudi. Ada tuas dorongan, stik kemudi, dan komputer kapal yang berbicara. Terbanglah ke planet mana pun yang kamu mau — tapi kurangi dorongan sebelum mendekat: menabrak terlalu kencang membuat kapal meledak. Tenang, kapal cadangan selalu siap.",
  ...
  en: {
    ...
    pilot: "Pilot mode",
    fsOn: "Full screen", fsOff: "Leave full screen", install: "Install app",
    ...
    sayBoom: "Ship destroyed!",
    sayRespawn: "Spare ship ready. Ease off the thrust before you get close, Captain.",
    ...
    h7t: "Fly the ship yourself", h7d: "Press the rocket button at the top right to take the controls. There is a thrust lever, a steering stick, and a ship computer that talks to you. Fly to any planet you like — but ease off the thrust before you get close: hitting a world too fast blows the ship up. Don't worry, a spare is always ready.",
